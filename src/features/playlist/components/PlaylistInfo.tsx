...
import { GoBackBtn } from '@/components/ui/atoms/Icons/GoBackBtn'
...
export function PlaylistInfo({ playlist, onClick}: Props) {
    return (
        <div style={{background: `linear-gradient(to bottom, ${playlist?.color.accent}, ${playlist?.color.dark})`}} className='flex flex-col gap-5 px-5 py-4'>
            <button 
            onClick={onClick} 
